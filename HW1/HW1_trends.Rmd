...
b = ggplot(seq_clim_trend, aes(x=year, precip)) +
  ...
  geom_point(data=seq_clim_trend, aes(x=year, precip), col="blue")

b = b + stat_smooth(method = 'lm', col = 'red')
b + stat_smooth(data = seq_clim_trend, aes(x=year, precip), col = 'blue', method = 'lm')
```
...
ggplot(subset(seq_clim_trend, seq_clim_trend$year %in% c(1927:1960)), aes(x=year, y=tmin_avg)) + 
  stat_summary(fun="mean", geom="point", col="red", size=4)+
...
ggplot(subset(seq_clim_trend, seq_clim_trend$year %in% c(2000:2020)), aes(x=year, y=tmin_avg)) + 
  stat_summary(fun="mean", geom="point", col="red", size=4)+
  theme(axis.text=element_text(size=14, face="bold"), axis.title=element_text(size=14, face="bold")) +
  geom_smooth(method="lm")
...
```{r}
### TMIN
t.test(subset(seq_clim_trend$tmin_avg, seq_clim_trend$year %in% 1927:1960), 
       subset(seq_clim_trend$tmin_avg, seq_clim_trend$year %in% 2000:2020))

wilcox.test(subset(seq_clim_trend$tmin_avg, seq_clim_trend$year %in% 1927:1960), 
            subset(seq_clim_trend$tmin_avg, seq_clim_trend$year %in% 2000:2020))
```
...
```{r}
### TMAX
t.test(subset(seq_clim_trend$tmax_avg, seq_clim_trend$year %in% 1927:1960), 
       subset(seq_clim_trend$tmax_avg, seq_clim_trend$year %in% 1980:2020))

wilcox.test(subset(seq_clim_trend$tmax_avg, seq_clim_trend$year %in% 1927:1960), 
            subset(seq_clim_trend$tmax_avg, seq_clim_trend$year %in% 1980:2020))
```
...
##plot 
ggplot(clim_summer, aes(x=year, y=tmax_avg)) + 
  stat_summary(fun="mean", geom="point", col="red", size=4) +
  theme(axis.text=element_text(size=14, face="bold"), 
        axis.title=element_text(size=14, face="bold")) +
  geom_smooth(method="lm")+labs(y=" Summer Minimum Daily Temperature C")
...
Summer max temps have significantly increased 0.218 F/year (p-value = 0.004)
...
##plot 
ggplot(clim_winter, aes(x=year, y=precip)) + 
...
### TMAX split
## early portion
res_early=lm(tmax_avg~year, data=subset(clim_summer, clim_summer$year %in% c(1927:1960)))
summary(res_early)
confint(res_early,"dt", level=0.90)
ggplot(subset(clim_summer, clim_summer$year %in% c(1927:1960)), aes(x=year, y=tmax_avg)) + 
  stat_summary(fun="mean", geom="point", col="red", size=4)+
  theme(axis.text=element_text(size=14, face="bold"), 
        axis.title=element_text(size=14, face="bold")) + 
  geom_smooth(method="lm")
...
# last four decades
res_late=lm(tmax_avg~year, data=subset(clim_summer, clim_summer$year %in% c(1980:2020)))
summary(res_late)
confint(res_late,"dt", level=0.90)
ggplot(subset(clim_summer, clim_summer$year %in% c(1980:2020)), aes(x=year, y=tmax_avg)) + 
  stat_summary(fun="mean", geom="point", col="red", size=4)+
  theme(axis.text=element_text(size=14, face="bold"), 
        axis.title=element_text(size=14, face="bold")) +
  geom_smooth(method="lm")
...
```{r}
### TMAX
t.test(subset(clim_summer$tmax_avg, clim_summer$year %in% 1927:1960), 
       subset(clim_summer$tmax_avg, clim_summer$year %in% 1980:2020))

wilcox.test(subset(clim_summer$tmax_avg, clim_summer$year %in% 1927:1960), 
            subset(clim_summer$tmax_avg, clim_summer$year %in% 1980:2020))
```
...
### precip split
## early portion
res_early=lm(precip~year, data=subset(clim_winter, clim_winter$year %in% c(1927:1960)))
summary(res_early)
confint(res_early,"dt", level=0.90)
ggplot(subset(clim_winter, clim_winter$year %in% c(1927:1960)), aes(x=year, y=precip)) + 
  stat_summary(fun="mean", geom="point", col="red", size=4)+
  theme(axis.text=element_text(size=14, face="bold"), 
        axis.title=element_text(size=14, face="bold")) + 
  geom_smooth(method="lm")
...
# last four decades
res_late=lm(precip~year, data=subset(clim_winter, clim_winter$year %in% c(1980:2020)))
summary(res_late)
confint(res_late,"dt", level=0.90)
ggplot(subset(clim_winter, clim_winter$year %in% c(1980:2020)), aes(x=year, y=precip)) + 
  stat_summary(fun="mean", geom="point", col="red", size=4)+
  theme(axis.text=element_text(size=14, face="bold"), 
        axis.title=element_text(size=14, face="bold")) +
  geom_smooth(method="lm")
...
```{r}
### precip
t.test(subset(clim_winter$precip, clim_winter$year %in% 1927:1960), 
       subset(clim_winter$precip, clim_winter$year %in% 1980:2020))

wilcox.test(subset(clim_winter$precip, clim_winter$year %in% 1927:1960), 
            subset(clim_winter$precip, clim_winter$year %in% 1980:2020))
```
